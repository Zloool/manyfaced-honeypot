"""ZabbixHandler - scaffold stub for issue #282.

TODO: replace the placeholder page with a realistic Zabbix impersonation
...
class ZabbixHandler(HTTPHandlerBase):
    """Zabbix honeypot handler (scaffold)."""
    ...
    def _main_page(self) -> str:
        """Zabbix placeholder page (scaffold)."""
        return (
            '<!DOCTYPE html><html><head><title>Zabbix</title></head>'
            f'<body><h1>Zabbix</h1>'
            f'<p>Service: Zabbix 6.4.0</p>'
            '</body></html>'
        )
