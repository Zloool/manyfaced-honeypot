"""AWSHandler - scaffold stub for issue #285.

TODO: replace the placeholder page with a realistic AWS impersonation
...
class AWSHandler(HTTPHandlerBase):
    """AWS honeypot handler (scaffold)."""

    domain = 'aws_creds'
    DETECTED_ID = AWS_HTTP
    VERSION = '1.0'
    ...
    def generate_response(
        ...
        """Generate a AWS response for the given request."""
    ...
    def __repr__(self) -> str:
        return f'AWSHandler(domain={self.domain!r})'
