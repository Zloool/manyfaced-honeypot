...
ROUTES: list[Route] = [
    ...
    Route(
        PathExact('/wp-config.php'),
        _config_disclosure(),
        CONFIG_DISCLOSURE_HTTP,
        'config_wp_config_php',
    ),
    Route(
    ...
    Route(
        PathExact('/config.php.bak'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_php_bak'
    ),
    Route(
        PathExact('/config.php.old'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_php_old'
    ),
    Route(
    ...
    Route(
        PathExact('/.env.local'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_env_local'
    ),
    Route(PathExact('/.env.prod'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_env_prod'),
    Route(
        PathExact('/.env.example'),
        _config_disclosure(),
        CONFIG_DISCLOSURE_HTTP,
        'config_env_example',
    ),
    Route(
        PathExact('/.env.sample'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_env_sample'
    ),
    # Apache config files
    Route(PathExact('/.htaccess'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_htaccess'),
    Route(
        PathExact('/.htaccess.bak'),
        _config_disclosure(),
        CONFIG_DISCLOSURE_HTTP,
        'config_htaccess_bak',
    ),
    ...
    Route(
        PathExact('/xmlrpc.php'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_xmlrpc_php'
    ),
    Route(
    ...
    Route(
        PathExact('/web.config'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_web_config'
    ),
    Route(
    ...
    Route(
        PathExact('/conf.php.bak'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_conf_bak'
    ),
    ...
    Route(
        PathExact('/local.php'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_local_php'
    ),
    Route(
    ...
    Route(
        PathExact('/app.config'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_app_config'
    ),
    Route(
        PathExact('/app.config.bak'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_app_bak'
    ),
    Route(
    ...
    Route(
        PathExact('/pip.conf.bak'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_pip_bak'
    ),
    Route(
    ...
    Route(
        PathExact('/setup.cfg'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_setup_cfg'
    ),
    Route(
    ...
    Route(
        PathExact('/tox.ini.bak'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_tox_bak'
    ),
    ...
    Route(
        PathExact('/Dockerfile'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_dockerfile'
    ),
    Route(
    ...
    Route(
        PathExact('/nginx.conf'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_nginx_conf'
    ),
    Route(
    ...
    Route(
        PathExact('/httpd.conf'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_httpd_conf'
    ),
    Route(
    ...
    Route(
        PathExact('/my.cnf.bak'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_my_cnf_bak'
    ),
    Route(
        PathExact('/mysqld.cnf'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_mysqld_cnf'
    ),
    Route(
    ...
    Route(
        PathExact('/redis.conf'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_redis_conf'
    ),
    Route(
    ...
    Route(
        PathExact('/test.php.bak'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_test_bak'
    ),
    Route(
        PathExact('/debug.php'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_debug_php'
    ),
    Route(
    ...
    Route(
        PathExact('/cli.php.bak'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_cli_bak'
    ),
    # Install / upgrade files
    Route(
        PathExact('/install.php'),
        _config_disclosure(),
        CONFIG_DISCLOSURE_HTTP,
        'config_install_php',
    ),
    ...
    # SQL dump files
    Route(
        PathExact('/backup.sql'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_backup_sql'
    ),
    Route(
    ...
    Route(
        PathExact('/dump.sql.bak'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_dump_bak'
    ),
    Route(
    ...
    Route(
        PathExact('/dump.sql.gz'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_dump_gz'
    ),
    Route(
        PathExact('/dump.sql.zip'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_dump_zip'
    ),
    Route(
    ...
    Route(
        PathExact('/backup.zip'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_backup_zip'
    ),
    ...
    Route(
        PathExact('/.git/config'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_git_config'
    ),
    Route(PathExact('/.git/head'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_git_head'),
    Route(
        PathExact('/.git/index'), _config_disclosure(), CONFIG_DISCLOSURE_HTTP, 'config_git_index'
    ),
