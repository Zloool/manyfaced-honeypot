...
ROUTES: list[Route] = [
    ...
    # NOTE: do NOT shadow generic ES probe paths (/_cluster,/_nodes,/_search,/_cat):
    # the router matches paths without port context, so registering them as
    # RabbitMQ would misclassify the same paths on the real ES port (9200).
    # Prefixes last.
