...
ROUTES: list[Route] = [
    ...
    Route(PathExact('/_mapping'), _elastic(), ELASTIC_HTTP, 'elastic_mapping'),
    Route(PathExact('/_all'), _elastic(), ELASTIC_HTTP, 'elastic_all'),
    ...
    Route(PathPrefix('/_aliases/'), _elastic(), ELASTIC_HTTP, 'elastic_aliases_prefix'),
    Route(PathPrefix('/_stats/'), _elastic(), ELASTIC_HTTP, 'elastic_stats_prefix'),
    Route(PathPrefix('/_status/'), _elastic(), ELASTIC_HTTP, 'elastic_status_prefix'),
    Route(PathPrefix('/_mapping/'), _elastic(), ELASTIC_HTTP, 'elastic_mapping_prefix'),
    Route(PathPrefix('/_all/'), _elastic(), ELASTIC_HTTP, 'elastic_all_prefix'),
