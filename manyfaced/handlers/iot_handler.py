"""IoTHandler - scaffold stub for issue #284.

TODO: replace the placeholder page with a realistic IoT Router impersonation
...
class IoTHandler(HTTPHandlerBase):
    """IoT Router honeypot handler (scaffold)."""
    ...
    def generate_response(
        ...
        """Generate a IoT Router response for the given request."""
    ...
    def _main_page(self) -> str:
        """IoT Router placeholder page (scaffold)."""
        return (
            '<!DOCTYPE html><html><head><title>IoT Router</title></head>'
            f'<body><h1>IoT Router</h1>'
            f'<p>Service: IoT Router 1.0</p>'
            '</body></html>'
        )
    ...
    def _build_http_response(
        ...
        response = (
            ...
            f'Server: IoT Router/{self.VERSION}\r\n'
            f'Date: {now}\r\n'
