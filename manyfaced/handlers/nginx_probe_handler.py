"""NginxProbeHandler - scaffold stub for issue #294.

TODO: replace the placeholder page with a realistic Nginx impersonation
...
class NginxProbeHandler(HTTPHandlerBase):
    """Nginx honeypot handler (scaffold)."""

    domain = 'nginx_probe'
    DETECTED_ID = NGINX_PROBE_HTTP
    VERSION = '1.24.0'
    ...
    def generate_response(
        ...
        """Generate a Nginx response for the given request."""
    ...
    def __repr__(self) -> str:
        return f'NginxProbeHandler(domain={self.domain!r})'
