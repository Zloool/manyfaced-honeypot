"""JupyterHandler - scaffold stub for issue #296.

TODO: replace the placeholder page with a realistic Jupyter impersonation
...
class JupyterHandler(HTTPHandlerBase):
    """Jupyter honeypot handler (scaffold)."""
    ...
    def _main_page(self) -> str:
        """Jupyter placeholder page (scaffold)."""
        return (
            '<!DOCTYPE html><html><head><title>Jupyter</title></head>'
            f'<body><h1>Jupyter</h1>'
            f'<p>Service: Jupyter 4.2.0</p>'
            '</body></html>'
        )
