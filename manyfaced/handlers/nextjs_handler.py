"""NextjsHandler - scaffold stub for issue #277.

TODO: replace the placeholder page with a realistic Next.js impersonation
...
class NextjsHandler(HTTPHandlerBase):
    """Next.js honeypot handler (scaffold)."""
    ...
    def _main_page(self) -> str:
        """Next.js placeholder page (scaffold)."""
        return (
            '<!DOCTYPE html><html><head><title>Next.js</title></head>'
            f'<body><h1>Next.js</h1>'
            f'<p>Service: Next.js 14.1.0</p>'
            '</body></html>'
        )
