"""PlexHandler - scaffold stub for issue #295.

TODO: replace the placeholder page with a realistic Plex impersonation
...
class PlexHandler(HTTPHandlerBase):
    """Plex honeypot handler (scaffold)."""
    ...
    def _main_page(self) -> str:
        """Plex placeholder page (scaffold)."""
        return (
            '<!DOCTYPE html><html><head><title>Plex</title></head>'
            f'<body><h1>Plex</h1>'
            f'<p>Service: Plex 1.32.0</p>'
            '</body></html>'
        )
