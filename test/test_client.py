...
from manyfaced.client.client import faces as faces_dict  # noqa: E402
...
class TestClient(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.responses_dir = os.path.join(
            cls.root_dir, "manyfaced", "client", "responses"
        )
    ...
    def test_compile_banner(self):
        ...
        self.assertIn(
            "Apache/1.3.42 (Unix)  (Red Hat/Linux)  OpenSSL/1.0.1e PHP/5.5.9 ", banner
        )
