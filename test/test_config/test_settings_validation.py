...
class TestConfigResolvePorts:
    ...
    def test_resolve_ports_top_default(self):
        ...
        cfg = Config(
            ...
            DB_PATH='bots/honeypot.db', DB_PG_HOST='localhost',
            DB_PG_PORT=5432, DB_PG_DB='honeypot', DB_PG_USER='postgres',
            DB_PG_PASSWORD='***', AUTHORIZED_BEES={}, HONEY_PORT_MODE='top',
            HONEY_TOP_PORTS='', DEFAULT_KEY='default_beehive_key',
            DUMP_FILE='dump.jsonl', LOG_FILE='~/.local/share/manyfaced/honeypot.log',
            LOCKFILE='/run/manyfaced/lockfile',
        )
    ...
    def test_resolve_ports_top_custom(self):
        ...
        cfg = Config(
            ...
            DB_PG_PORT=5432, DB_PG_DB='honeypot', DB_PG_USER='postgres',
            DB_PG_PASSWORD='***', AUTHORIZED_BEES={}, HONEY_PORT_MODE='top',
            HONEY_TOP_PORTS='80,443,8080,3306', DEFAULT_KEY='default_beehive_key',
            DUMP_FILE='dump.jsonl', LOG_FILE='~/.local/share/manyfaced/honeypot.log',
            LOCKFILE='/run/manyfaced/lockfile',
        )
    ...
    def test_resolve_ports_top_custom_with_spaces(self):
        ...
        cfg = Config(
            ...
            DB_PG_PORT=5432, DB_PG_DB='honeypot', DB_PG_USER='postgres',
            DB_PG_PASSWORD='***', AUTHORIZED_BEES={}, HONEY_PORT_MODE='top',
            HONEY_TOP_PORTS='80, 443, 8080', DEFAULT_KEY='default_beehive_key',
            DUMP_FILE='dump.jsonl', LOG_FILE='~/.local/share/manyfaced/honeypot.log',
            LOCKFILE='/run/manyfaced/lockfile',
        )
    ...
    def test_resolve_ports_all(self):
        ...
        cfg = Config(
            ...
            DB_PATH='bots/honeypot.db', DB_PG_HOST='localhost',
            DB_PG_PORT=5432, DB_PG_DB='honeypot', DB_PG_USER='postgres',
            DB_PG_PASSWORD='***', AUTHORIZED_BEES={}, HONEY_PORT_MODE='all',
            HONEY_TOP_PORTS='', DEFAULT_KEY='default_beehive_key',
            DUMP_FILE='dump.jsonl', LOG_FILE='~/.local/share/manyfaced/honeypot.log',
            LOCKFILE='/run/manyfaced/lockfile',
        )
...
""")
        ...
        assert result.stdout.strip() == "''", (
            f'Expected empty HIVEPASS, got {result.stdout!r}'
        )
...
""")
        ...
        assert result.stdout.strip() == "''", (
            f'Expected empty DEFAULT_KEY, got {result.stdout!r}'
        )
